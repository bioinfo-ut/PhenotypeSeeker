...
class annotate():
    ...
    def get_kmer_annotations(cls, kmers):
        for kmer in kmers:
            ...
            mode_product = cls.kmer_annotations[kmer]["product"].mode()
            print(mode_product[0])
            print(cls.kmer_annotations[kmer].product[cls.kmer_annotations[kmer].product == mode_product[0]])
